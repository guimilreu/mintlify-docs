...
<CardGroup cols={2}>
  ...
  <Card title="JSON em tudo" icon="braces">
...
<CardGroup cols={3}>
  ...
  <Card title="Funis de venda" icon="kanban" href="/api-reference/pipelines/list">
  ...
  <Card title="Agentes de IA" icon="bot" href="/api-reference/ai-agents/list">
    Configure, publique e monitore agentes de IA de vendas e suporte.
  </Card>
  <Card title="Disparos" icon="megaphone" href="/api-reference/broadcasts/list">
    Campanhas de disparo em massa via WhatsApp com segmentação de audiência.
  </Card>
  <Card title="Campos personalizados" icon="sliders" href="/api-reference/custom-fields/list">
