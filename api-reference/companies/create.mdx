...
<Note>
Criar, atualizar e excluir empresa disparam `company.created`, `company.updated` e `company.deleted`.
</Note>
<Note>
  Não há endpoint de **notas de empresa** na v1 — só em contatos e negócios. O evento
