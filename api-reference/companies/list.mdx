...
| `contacts_count` | integer | Contatos vinculados à empresa |
| `deals_count` | integer | Negócios vinculados à empresa |
| `total_deals_value` | number | Soma do valor dos negócios vinculados |
