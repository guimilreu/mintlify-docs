...
**Escopo necessário:** `read:deals` — disponível nos plano **Growth ou superior**
...
| `stage_id` | string | Filtra por etapa. Aceita o **ID** da etapa ou o nome exato |
...
| `won_reason` | string\|null | Motivo do ganho, quando informado |
| `loss_reason` | string\|null | Motivo da perda, quando informado |
