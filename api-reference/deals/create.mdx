---
title: "Criar negócio"
description: "Cria um novo negócio em um pipeline."
---
...
| `stage_id` | string | Não | ID da etapa. Se omitido, usa a primeira etapa do pipeline |
...
| `NO_STAGES` | `422` | Pipeline não tem etapas |
